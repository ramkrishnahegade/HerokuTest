...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
	...
	/*
	 * @GetMapping("/hello") String index() { return "hello"; }
	 */
	/*
	 * @RequestMapping("/db") String db(Map<String, Object> model) { try (Connection
	 * connection = dataSource.getConnection()) { Statement stmt =
	 ...
	 * 
	 * model.put("records", output); return "db"; } catch (Exception e) {
	 * model.put("message", e.getMessage()); return "error"; } }
	 * 
